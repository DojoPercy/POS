  ...
  return (
    <header className='sticky top-0 z-10 flex h-16 items-center justify-between border-b border-slate-200 bg-white px-6'>
      <div className='flex items-center gap-4'>
        ...
        <div>
          <h1 className='text-md lg:text-lg  font-normal text-slate-900'>
            {'Company ' + currentPageName}
          </h1>
          <p className='text-sm text-slate-500'>
            {company?.name || 'Restaurant'} Management
          </p>
        </div>
      </div>
      ...
      <div className='flex items-center gap-4'>
        ...
        <div className='hidden lg:flex relative'>
          ...
          <Input
            placeholder='Search...'
            className='w-48 xl:w-64 pl-9 bg-slate-50 border-slate-200 focus:bg-white'
          />
        </div>
          ...
          <div className='text-right'>
            ...
            <div className='flex items-center gap-1 text-xs text-slate-500'>
              ...
              <span>
                ...
                {activeBranches.length === 1 ? 'Branch' : 'Branches'}
              </span>
            </div>
          </div>
          <Button
