...
export function AddFrequentItemDialog({ open, onOpenChange }: AddFrequentItemDialogProps) {
      ...
      <DialogContent className="sm:max-w-[425px]">
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            ...
            <DialogDescription>Create a new frequent item for quick expense entry.</DialogDescription>
          </DialogHeader>
