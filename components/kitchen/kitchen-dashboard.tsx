  ...
  const getOrderNotes = (order: OrderType) => {
    ...
    return notesLines.map((line, index) => {
      ...
      return (
        <div
          key={index}
          className='text-xs text-gray-600 mt-1 flex items-start'
        >
                      ...
                      <div className='p-5'>
                        ...
                        {order.orderStatus !== OrderStatus.COMPLETED && (
                          <div className='flex items-center mb-3'>
                            <Timer
                              className={`h-4 w-4 mr-1.5 ${waitTimeColor}`}
                            />
                            <span
                              className={`text-sm font-medium ${waitTimeColor}`}
                            >
                              {waitTime} min wait
                            </span>
                          </div>
                    ...
                    <div className='flex items-center space-x-4 mt-3 md:mt-0'>
                      {order.orderStatus !== OrderStatus.COMPLETED && (
                        <div className='flex items-center'>
                          ...
                          <span
                            className={`text-xs font-medium ${waitTimeColor}`}
                          >
                            {waitTime} min
                          </span>
                        </div>
