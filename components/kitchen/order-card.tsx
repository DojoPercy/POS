...
export default function OrderCard({ order, onViewDetails, onAccept, onComplete }: OrderCardProps) {
        ...
        <div className="p-4">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="space-x-2">
              {order.orderStatus === OrderStatus.PENDING && (
                <Button size="sm" className="bg-blue-600 hover:bg-blue-700" onClick={() => onAccept(order)}>
                  <ChefHat className="h-4 w-4 mr-1" /> Accept
                </Button>
              )}

              {order.orderStatus === OrderStatus.PROCESSING && (
                <Button size="sm" className="bg-green-600 hover:bg-green-700" onClick={() => onComplete(order)}>
