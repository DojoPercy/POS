...
import { TrendingUp, TrendingDown, DollarSign, ShoppingCart, FileText } from "lucide-react";
import { FinancialAnalyticsService, FinancialAnalyticsResponse } from "@/lib/financial-analytics";
...
export default function FinancialAnalyticsChart({ 
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await FinancialAnalyticsService.getFinancialAnalytics(companyId, {
        from,
        to,
        groupBy,
      });
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            <div className="bg-blue-50 p-4 rounded-lg">
              ...
              <div className="flex items-center gap-1 mt-2">
                ...
                <span className={`text-sm font-medium ${getTrendColor(data.summary.revenueTrend)}`}>
            ...
            <div className="bg-green-50 p-4 rounded-lg">
              ...
              <div className="flex items-center gap-1 mt-2">
                ...
                <span className={`text-sm font-medium ${getTrendColor(data.summary.profitTrend)}`}>
