...
export function OrderForm() {
  ...
  useEffect(() => {
    const newTotalPrice = orderLines.reduce((sum, line) => sum + line.totalPrice, 0)
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <div>
                ...
                <RadioGroup value={paymentType} onValueChange={(value: string) => setPaymentType(value as PaymentType)}>
                  <div className="flex items-center space-x-2">
