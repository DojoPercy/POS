...
export default function AddExpensePage() {
  ...
  const [selectedFrequentItem, setSelectedFrequentItem] = useState<string | null>(null)
  ...
  const {  status, error, Frequent, categories } = useSelector((state: RootState) => state.expenses);
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) => setUseFrequentItem(checked as boolean)}
              />
            ...
            {!useFrequentItem && (
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => setFormData({ ...formData, isFrequent: checked as boolean })}
                />
