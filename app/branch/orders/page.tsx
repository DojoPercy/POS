    ...
    <div className="py-6 px-10">
      <div className="flex flex-row mb-6">
        <div className="mr-auto flex">
          <h1 className="mr-auto font-bold text-2xl flex items-center">Orders</h1>
          ...
          <Dialog open={bulkOrderOpen} onOpenChange={setBulkOrderOpen}>
            ...
            <DialogContent className="sm:max-w-[425px]">
              <DialogHeader>
                ...
                <DialogDescription>
                  Enter the total amount for this bulk order. No need to specify individual items.
                </DialogDescription>
              </DialogHeader>
              ...
              <DialogFooter>
                <Button type="submit" onClick={handleCreateBulkOrder} disabled={isSubmitting || !totalPrice}>
                  {isSubmitting ? (
                    <>
