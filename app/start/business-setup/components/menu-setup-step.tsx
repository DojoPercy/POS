...
export function MenuSetupStep({
  ...
  const validateForm = () => {
    ...
    if (!hasNamedCategory) {
      newErrors.categories =
        'At least one menu category with a name is required';
    }
  ...
  const activeCategoryData =
    formData.menuCategories.find((cat: any) => cat.id === activeCategory) ||
    ...
    <div className='space-y-6'>
      <div className='text-center mb-6'>
        ...
        <p className='text-gray-600 dark:text-gray-300'>
          Create your menu categories and items
        </p>
      </div>
              ...
              <Card className='mt-6'>
                <CardContent className='p-4'>
                  <h4 className='font-medium mb-4'>
                    Edit Category: {activeCategoryData.name || 'New Category'}
                  </h4>
          ...
          <TabsContent value='items' className='space-y-4 pt-4'>
            ...
            {activeMenuItemData && (
              <Card className='mt-6'>
                <CardContent className='p-4'>
                  <h4 className='font-medium mb-4'>
                    Edit Menu Item: {activeMenuItemData.name || 'New Item'}
                  </h4>
                    ...
                    <div className='space-y-3'>
                      <div className='flex items-center justify-between'>
                        ...
                        <Button
                          ...
                          size='sm'
                          onClick={() =>
                            addPriceType(activeCategory, activeMenuItemData.id)
                          }
                      ...
                      <Accordion type='multiple' className='w-full'>
                        {activeMenuItemData.priceTypes.map(
                              ...
                              <AccordionContent>
                                <div className='space-y-3 py-2'>
                                  <div className='grid grid-cols-2 gap-3'>
                                    <div className='space-y-2'>
                                      <Label
                                        htmlFor={`priceName-${priceType.id}`}
                                        className='text-sm font-medium'
                                      >
                                        Name
                                      </Label>
                                    ...
                                    <div className='space-y-2'>
                                      <Label
                                        htmlFor={`priceValue-${priceType.id}`}
                                        className='text-sm font-medium'
                                      >
                                        Price
                                      </Label>
            ...
            {activeMenuItemData ? (
              <div>
                <div className='flex items-center justify-between mb-4'>
                  <h3 className='text-lg font-medium'>
                    Ingredients for:{' '}
                    {activeMenuItemData.name || 'New Menu Item'}
                  </h3>
                </div>
                <MenuIngredients
              ...
              <div className='flex flex-col items-center justify-center py-12 text-center'>
                ...
                <p className='text-muted-foreground max-w-md'>
                  Please select a menu item from the &rdquo;Menu Items&rdquo;
                  tab to manage its ingredients
                </p>
                <Button
                  variant='outline'
                  className='mt-4'
