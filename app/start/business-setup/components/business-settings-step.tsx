...
export function BusinessSettingsStep({ formData, updateFormData, nextStep, prevStep }: BusinessSettingsStepProps) {
  ...
  const validateForm = () => {
    ...
    if (!formData.orderProcessingMode) newErrors.orderProcessingMode = "Order processing mode is required"
    if (!formData.currency) newErrors.currency = "Currency is required"
    if (formData.taxRate === undefined || formData.taxRate === null) newErrors.taxRate = "Tax rate is required"
  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-6">
        ...
        <p className="text-gray-600 dark:text-gray-300">Configure your business operations</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                `}
                >
                  {formData.orderProcessingMode === "restaurant" && <div className="w-3 h-3 rounded-full bg-primary" />}
                </div>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                `}
                >
                  {formData.orderProcessingMode === "retail" && <div className="w-3 h-3 rounded-full bg-primary" />}
                </div>
                <div className="flex items-center space-x-2">
          ...
          {errors.orderProcessingMode && <p className="text-sm text-red-500">{errors.orderProcessingMode}</p>}
        </div>
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(checked) => handleChange("enableDiscounts", checked)}
            />
          </div>
