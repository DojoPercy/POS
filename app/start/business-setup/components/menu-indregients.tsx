...
export function MenuIngredients(this: any, {
  companyId,
  menuId,
  initialIngredients = [],
  allIngredients = [],
  ...
  const [menuIngredients, setMenuIngredients] = useState<MenuIngredient[]>(initialIngredients)
              ...
              {menuIngredients.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-8 text-center">
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    Select ingredients from the list to add them to this menu item
                  </p>
                </div>
              ) : (
                    ...
                    {menuIngredients.map((menuIngredient, index) => (
                      ...
                      >
                        <div className="flex-1">
                          <div className="font-medium">{menuIngredient.ingredient.name}</div>
