...
export function BranchesStep({ formData, updateFormData, nextStep, prevStep }: BranchesStepProps) {
  ...
  const validateForm = () => {
    ...
    const hasCompleteBranch = formData.branches.some(
      (branch: any) => branch.name && branch.location && branch.manager.name && branch.manager.email,
    )

    if (!hasCompleteBranch) {
      newErrors.branches = "At least one branch with complete information is required"
    }
  ...
  const addBranch = () => {
    const updatedBranches = [...formData.branches, { name: "", location: "", manager: { name: "", email: "" } }]
  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-6">
        ...
        <p className="text-gray-600 dark:text-gray-300">Set up your business locations and assign managers</p>
      </div>
            ...
            <CardContent className="p-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div className="space-y-2">
                  <Label htmlFor={`branch-name-${index}`} className="text-sm font-medium">
                    Branch Name
                  </Label>
                ...
                <div className="space-y-2">
                  <Label htmlFor={`branch-location-${index}`} className="text-sm font-medium">
                    Branch Location
                  </Label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none text-gray-500">
              ...
              <div className="border-t border-gray-200 dark:border-gray-700 pt-4 mt-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor={`manager-name-${index}`} className="text-sm font-medium">
                      Manager Name
                    </Label>
                    <div className="relative">
                      <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none text-gray-500">
                      ...
                      <Input
                        ...
                        onChange={(e) => updateBranch(index, "manager.name", e.target.value)}
                        className="pl-10"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor={`manager-email-${index}`} className="text-sm font-medium">
                      Manager Email
                    </Label>
                    <div className="relative">
                      <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none text-gray-500">
                      ...
                      <Input
                        ...
                        onChange={(e) => updateBranch(index, "manager.email", e.target.value)}
                        className="pl-10"
                ...
                <p className="text-xs text-gray-500 mt-2">
                  An email with login instructions will be sent to the manager after setup.
                </p>
              </div>
            </CardContent>
          </Card>
