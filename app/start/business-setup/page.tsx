...
export default function BusinessSetupPage() {
  ...
  const renderStep = () => {
    switch (currentStep) {
      case 1:
        return <SignUpStep formData={formData} updateFormData={updateFormData} nextStep={nextStep} />
      case 2:
        return (
          <BusinessDetailsStep
            formData={formData}
      ...
      case 4:
        return (
          <BranchesStep formData={formData} updateFormData={updateFormData} nextStep={nextStep} prevStep={prevStep} />
        )
      case 5:
        return (
