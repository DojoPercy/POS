...
function SideBarIcon({
  ...
  return (
    <Link href={modifiedHref}>
      <div
        className={
          'relative flex items-center justify-center h-12 w-12 my-2 mx-auto transition-colors duration-300 ease-linear cursor-pointer group rounded-xl  text-zinc-900 bg-white ' +
