  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      if (orders && orders.length > 0) {
        const pendingOrder = orders.find((order: OrderType) => order.orderStatus === OrderStatus.PENDING)
        if (pendingOrder) {
          setNewOrderAlert(true)
    ...
    <div className="container mx-auto py-6">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex items-center space-x-4">
          ...
          <Button variant="outline" size="icon" className="border-gray-200 text-gray-700 hover:text-gray-900">
              ...
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <div>
                      <h3 className="font-semibold text-amber-800">New Order Received!</h3>
                      <p className="text-sm text-amber-700">
                        Order #{latestOrder.orderNumber} is waiting to be accepted
                      </p>
                    </div>
                  </div>
