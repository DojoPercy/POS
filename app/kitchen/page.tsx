...
export default function KitchenPage() {
 ...
 useEffect(() => {
  ...
  const getFilteredOrders = () => {
    ...
    switch (activeTab) {
      case "pending":
        return orders.filter((order: OrderType) => filteredOrders.orderStatus === OrderStatus.PENDING)
      case "processing":
        return orders.filter((order: OrderType) => filteredOrders.orderStatus === OrderStatus.PROCESSING)
      case "completed":
        return orders.filter((order: OrderType) => filteredOrders.orderStatus === OrderStatus.COMPLETED)
      default:
