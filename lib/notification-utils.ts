...
export class NotificationUtils {
  ...
  static async createStaffNotification(staffData: any, action: "added" | "updated" | "removed") {
    const decodedToken = this.getToken()
  ...
  static async createMenuNotification(menuData: any, action: "added" | "updated" | "removed") {
    const decodedToken = this.getToken()
  ...
  static async createBranchNotification(branchData: any, action: "added" | "updated" | "removed") {
    const decodedToken = this.getToken()
  ...
  static async createSystemMaintenanceNotification(message: string, priority: "LOW" | "MEDIUM" | "HIGH" | "URGENT" = "MEDIUM") {
    const decodedToken = this.getToken()
  ...
  static async createUserSpecificNotification(userId: string, title: string, message: string, priority: "LOW" | "MEDIUM" | "HIGH" | "URGENT" = "MEDIUM") {
    return this.createNotification({
      title,
      message,
      type: "USER",
  ...
  static async createBulkBranchNotification(branchIds: string[], title: string, message: string, priority: "LOW" | "MEDIUM" | "HIGH" | "URGENT" = "MEDIUM") {
  ...
  static async createBulkUserNotification(userIds: string[], title: string, message: string, priority: "LOW" | "MEDIUM" | "HIGH" | "URGENT" = "MEDIUM") {
  ...
  static async createTopBranchNotification(branchData: any, metric: string, value: string) {
    const decodedToken = this.getToken()
  ...
  static async createHighestOrderNotification(orderData: any, branchName: string) {
    const decodedToken = this.getToken()
  ...
  static async createTopAttendanceNotification(userData: any, attendanceData: any) {
    const decodedToken = this.getToken()
  ...
  static async createEmployeePerformanceNotification(employeeData: any, performanceData: any) {
    const decodedToken = this.getToken()
